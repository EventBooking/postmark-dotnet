...
namespace Postmark.PCL.Tests
{
    ...
    public abstract class ClientBaseFixture
    {
        ...
        private static void AssertSettingsAvailable()
        {
            ...
            Assert.NotNull(WRITE_TEST_DOMAIN_NAME, "WRITE_TEST_DOMAIN_NAME must be defined as an environment variable or app setting.");
        ...
        public static readonly string WRITE_TEST_DOMAIN_NAME = ConfigVariable("WRITE_TEST_DOMAIN_NAME");
